                ...
                <div class="row mt-5 d-flex justify-content-center">
                    <div class="col-xxl-4 col-lg-6 col-sm-12 mb-5" style="height: 606px">
                        <div class="overdue p-3 shadow rounded-3 bg-white d-flex flex-column h-100" style="min-width: 250px;">
                            ...
                            <div class="card-body">
                                <h4 class="card-title text-danger">Просроченные задачи</h4>
                                <div class="overdue__list mt-4">
                                    <div class="overdue__none d-flex flex-column align-items-center">
                                        ...
                                        <p class="card-text text-center mt-4" style="color: #53B6FD; opacity: 0.33;">У вас нет просроченных задач</p>
                                    </div>
                                </div>
                            </div>
                            <button class="btn align-self-center mt-auto">Показать еще</button>                        
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="myprojects__list overflow-auto" style="height: 130px;">
                                    <div class="myprojects__list-item d-flex flex-wrap">
                                        ...
                                        <p class="card-text">Приложение Task Manager<br><date class="fs-6" style="color:var(--color1);">15.05.2022</date></p>
                                    </div>
                                </div>
                            </div>
                            <button class="btn align-self-center mt-auto">Показать еще</button>  
